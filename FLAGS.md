...
- Works with specialized agents for domain-specific delegation
...
Flags can combine agents with personas for enhanced specialization:
- `--agent-architect --persona-mentor`: Educational system analysis
- `--agent-coder --persona-refactorer`: Clean code implementation
